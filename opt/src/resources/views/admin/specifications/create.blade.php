                    ...
                    <form action="{{ route('admin.specifications.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="md:col-span-2">
                                <div class="flex items-center">
                                    <input type="checkbox" name="has_multiple_values" id="has_multiple_values" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ old('has_multiple_values') ? 'checked' : '' }}>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    ...
                                    After creating the specification, you'll be able to add values.
                                </p>
                            </div>
                        </div>
